...
public class MainActivity extends Activity {
    ...
    @Override public void onCreate(Bundle b){
        ...
        ArrayAdapter<String> a=new ArrayAdapter<>(this,android.R.layout.simple_spinner_dropdown_item,
                new String[]{"Kettensense: Distanz lernen (experimentell)","Kettensense: großer Abstand","Kettensense: kürzerer Abstand"});
    ...
    @Override protected void onResume(){super.onResume();status.setText(accessibilityEnabled()?"Bereit | "+new RangeLearner(this).summary():"Bitte zuerst Bedienungshilfe aktivieren");}
